...
var data = [originalData[0], originalData[1], originalData[2], originalData[3], originalData[4], originalData[5], originalData[6], originalData[7], originalData[8], originalData[9]]; // 排序

function changeSort(event, prop) {
  var sortN = prop.data.on.click[1];
  sortBy = sortN; // console.log(sortBy)
...
function remove(event, movie) {
  var delMovie = movie.data.on.click[1]; // console.log(delMovie)
